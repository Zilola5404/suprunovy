...
sessionStorage:localStorage).getItem("DataTables_"+a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": по возрастанию",
sSortDescending:": по убыванию"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"&#x2192;",sPrevious:"&#x2190;"},sEmptyTable:"Данные отсутствуют",sInfo:"Показать _START_ по _END_ из _TOTAL_ записей",sInfoEmpty:"Показать 0 по 0 из 0 записей",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_ записей",sLoadingRecords:"Загрузка...",sProcessing:"Обработка...",sSearch:"Отобразить:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Совпадающих записей не найдено"},
